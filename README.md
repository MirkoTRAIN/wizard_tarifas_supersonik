...
```
.
├── index.html              ← Wizard "minimalista" (sin marketing)
├── wizard-landing.html     ← Versión landing page con hero + features + CTA
...
- **`index.html`** — wizard limpio en página completa. Diseño minimal, body sin scroll, panel izquierdo + panel derecho a la misma altura. Ideal si quieres servir solo el configurador.
- **`wizard-landing.html`** — la misma lógica con un **wrapper de landing page**: hero oscuro con call-to-action, sección del wizard, pasos 1·2·3, grid de features y CTA final. Inspirado en el estilo de `go.trainingym.com/mundial-app-gratis`.
